<?php
/**
 * Weather Calculators Collection
 * File: weather/index.php
 * Description: Landing page for 9 weather and environmental calculation tools
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Weather Calculators - 9 Free Tools | Climate & Environmental</title>
    <meta name="description" content="Complete collection of weather calculators: BTU, wind chill, heat index, dew point, rainfall, solar panel, carbon offset, and more. Essential climate tools.">
    <style>
...
<body>
    <header class="fade-in">
        <h1>🌦️ Weather Calculators</h1>
        <p>Professional weather and environmental calculation tools for climate analysis, energy efficiency, and sustainability. Essential for homeowners, farmers, and environmentalists.</p>
    </header>
    ...
    <div class="container">
        ...
        <div class="search-box fade-in">
            <input type="text" class="search-input" id="searchInput" placeholder="🔍 Search weather calculators..." onkeyup="filterCalculators()">
        </div>

        <!-- Weather & Climate -->
        <div class="category fade-in" data-category="weather">
            <div class="category-header">
                <span class="category-icon">🌡️</span>
                <h2 class="category-title">Weather & Climate</h2>
                <span class="category-count">5 Tools</span>
            </div>
            <div class="calc-grid">
                <a href="wind-chill-calculator.php" class="calc-card slide-in-left" data-name="Wind Chill Calculator">
                    <div class="calc-icon">💨</div>
                    <div class="calc-title">Wind Chill Calculator</div>
                    <div class="calc-desc">Calculate apparent temperature based on wind speed and air temperature.</div>
                    <span class="calc-badge">Popular</span>
                </a>
                <a href="heat-index-calculator.php" class="calc-card slide-in-left" data-name="Heat Index Calculator">
                    <div class="calc-icon">🌡️</div>
                    <div class="calc-title">Heat Index Calculator</div>
                    <div class="calc-desc">Calculate "feels like" temperature from heat and humidity levels.</div>
                </a>
                <a href="dew-point-calculator.php" class="calc-card slide-in-left" data-name="Dew Point Calculator">
                    <div class="calc-icon">💧</div>
                    <div class="calc-title">Dew Point Calculator</div>
                    <div class="calc-desc">Calculate dew point temperature from relative humidity and air temperature.</div>
                </a>
                <a href="rainfall-calculator.php" class="calc-card slide-in-left" data-name="Rainfall Calculator">
                    <div class="calc-icon">🌧️</div>
                    <div class="calc-title">Rainfall Calculator</div>
                    <div class="calc-desc">Calculate rainfall amount, water volume, and catchment area.</div>
                </a>
                <a href="snow-to-water-calculator.php" class="calc-card slide-in-left" data-name="Snow to Water Calculator">
                    <div class="calc-icon">❄️</div>
                    <div class="calc-title">Snow to Water Calculator</div>
                    <div class="calc-desc">Convert snow depth to water equivalent for accurate precipitation measurement.</div>
                </a>
            </div>
        </div>
        ...
        <div class="category fade-in" data-category="energy">
            <div class="category-header">
                ...
                <h2 class="category-title">Energy & HVAC</h2>
                <span class="category-count">2 Tools</span>
            </div>
            <div class="calc-grid">
                <a href="btu-calculator.php" class="calc-card slide-in-right" data-name="BTU Calculator">
                    <div class="calc-icon">🔥</div>
                    <div class="calc-title">BTU Calculator</div>
                    <div class="calc-desc">Calculate heating and cooling BTU requirements for your space.</div>
                    <span class="calc-badge">Essential</span>
                </a>
                <a href="solar-panel-calculator.php" class="calc-card slide-in-right" data-name="Solar Panel Calculator">
                    <div class="calc-icon">☀️</div>
                    <div class="calc-title">Solar Panel Calculator</div>
                    <div class="calc-desc">Calculate solar panel requirements, energy production, and cost savings.</div>
                    <span class="calc-badge">Popular</span>
                </a>
            </div>
        </div>
        ...
        <!-- Sustainability -->
        <div class="category fade-in" data-category="sustainability">
            <div class="category-header">
                <span class="category-icon">🌱</span>
            ...
            <div class="calc-grid">
                <a href="carbon-offset-calculator.php" class="calc-card slide-in-left" data-name="Carbon Offset Calculator">
                    <div class="calc-icon">🌍</div>
                    <div class="calc-title">Carbon Offset Calculator</div>
                    <div class="calc-desc">Calculate carbon footprint and offset requirements for sustainability.</div>
                </a>
                <a href="compost-calculator.php" class="calc-card slide-in-left" data-name="Compost Calculator">
                    <div class="calc-icon">♻️</div>
                    <div class="calc-title">Compost Calculator</div>
                    <div class="calc-desc">Calculate compost pile ratios for optimal decomposition and nutrients.</div>
                </a>
            </div>
        </div>
    ...
    <footer class="fade-in">
        <p>🌦️ Weather Calculators | 9 Free Tools</p>
        <p style="margin-top: 8px; font-size: 0.875rem;">Professional weather and environmental calculations</p>
    </footer>
