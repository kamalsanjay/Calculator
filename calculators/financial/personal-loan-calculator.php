 ...
 * File: personal-loan-calculator.php
 * Description: Calculate personal loan EMI and repayment schedule (USD/INR)
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Personal Loan Calculator - Calculate Loan EMI (USD/INR)</title>
    <meta name="description" content="Free personal loan calculator. Calculate monthly EMI, total interest, and repayment schedule. Plan your personal loan with USD and INR support.">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <header>
        ...
        <p>Calculate your personal loan EMI and repayment schedule</p>
    </header>
            ...
            <div class="calculator-section">
                ...
                <form id="personalLoanForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="loanAmount" value="25000" min="1000" step="1000" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="interestRate">Interest Rate (% per annum)</label>
                        <input type="number" id="interestRate" value="12" min="1" max="36" step="0.1" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="loanTenure">Loan Tenure (Years)</label>
                        <input type="number" id="loanTenure" value="3" min="1" max="10" step="1" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="processingFee">Processing Fee (<span id="currencyLabel2">$</span>)</label>
                        <input type="number" id="processingFee" value="500" min="0" step="100">
                        <small>One-time upfront fee</small>
                    </div>
            ...
            <div class="results-section">
                ...
                <div class="breakdown">
                    ...
                    <div class="breakdown-item">
                        ...
                        <strong id="feeDisplay">$0</strong>
                    </div>
                    <div class="breakdown-item">
                        <span>Monthly EMI</span>
                        <strong id="emiDisplay">$0</strong>
                    </div>
                </div>
                ...
                <div class="breakdown" style="margin-top: 20px;">
                    ...
                    <div class="breakdown-item">
                        ...
                        <strong id="amountBorrowed">$0</strong>
                    </div>
                    <div class="breakdown-item">
                        <span>Interest Cost</span>
                        <strong id="interestCost">$0</strong>
                    </div>
                    <div class="breakdown-item">
                        <span>Interest Rate %</span>
                        <strong id="interestPercentage">0%</strong>
                    </div>
                    <div class="breakdown-item">
                ...
                <div class="info-box">
                    <strong>Personal Loan Tips:</strong> Compare interest rates from multiple lenders. Lower tenure = lower interest but higher EMI. Processing fees typically 1-2% of loan amount. Check for prepayment penalties before early closure.
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function calculateLoan() {
            ...
            const effectiveRate = loanAmount > 0 ? ((totalCost - loanAmount) / loanAmount) * 100 : 0;
            ...
            document.getElementById('feeDisplay').textContent = formatCurrency(processingFee, currency);
            document.getElementById('emiDisplay').textContent = formatCurrency(emi, currency);
            ...
            document.getElementById('totalPayable').textContent = formatCurrency(totalCost, currency);

            document.getElementById('amountBorrowed').textContent = formatCurrency(loanAmount, currency);
