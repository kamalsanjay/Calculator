<?php
/**
 * Cooking Calculators Collection
 * File: cooking/index.php
 * Description: Landing page for 9 cooking and recipe calculation tools
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Cooking Calculators - 9 Free Tools | Recipe & Kitchen Helpers</title>
    <meta name="description" content="Complete collection of cooking calculators: recipe converter, scaling, cooking time, ingredient substitution, baking conversion, nutrition, and more. Essential kitchen tools.">
    <style>
...
<body>
    <header class="fade-in">
        <h1>👨‍🍳 Cooking Calculators</h1>
        <p>Professional cooking and recipe calculation tools for home cooks, bakers, and chefs. Perfect for meal prep, recipe conversion, and nutrition tracking.</p>
    </header>
    ...
    <div class="container">
        ...
        <div class="search-box fade-in">
            <input type="text" class="search-input" id="searchInput" placeholder="🔍 Search cooking calculators..." onkeyup="filterCalculators()">
        </div>

        <!-- Recipe Tools -->
        <div class="category fade-in" data-category="recipe">
            <div class="category-header">
                <span class="category-icon">📖</span>
                <h2 class="category-title">Recipe Tools</h2>
                <span class="category-count">4 Tools</span>
            </div>
            <div class="calc-grid">
                <a href="recipe-converter.php" class="calc-card slide-in-left" data-name="Recipe Converter">
                    <div class="calc-icon">🔄</div>
                    <div class="calc-title">Recipe Converter</div>
                    <div class="calc-desc">Convert recipe measurements between metric and imperial units.</div>
                    <span class="calc-badge">Popular</span>
                </a>
                <a href="recipe-scaling-calculator.php" class="calc-card slide-in-left" data-name="Recipe Scaling Calculator">
                    <div class="calc-icon">⚖️</div>
                    <div class="calc-title">Recipe Scaling Calculator</div>
                    <div class="calc-desc">Scale recipes up or down for different serving sizes.</div>
                    <span class="calc-badge">Essential</span>
                </a>
                <a href="cooking-time-calculator.php" class="calc-card slide-in-left" data-name="Cooking Time Calculator">
                    <div class="calc-icon">⏱️</div>
                    <div class="calc-title">Cooking Time Calculator</div>
                    <div class="calc-desc">Calculate cooking times based on weight, temperature, and food type.</div>
                </a>
                <a href="ingredient-substitution-calculator.php" class="calc-card slide-in-left" data-name="Ingredient Substitution">
                    <div class="calc-icon">🔀</div>
                    <div class="calc-title">Ingredient Substitution</div>
                    <div class="calc-desc">Find ingredient substitutes and conversion ratios for cooking.</div>
                </a>
            </div>
        </div>

        <!-- Baking Tools -->
        <div class="category fade-in" data-category="baking">
            <div class="category-header">
                <span class="category-icon">🥖</span>
                <h2 class="category-title">Baking Tools</h2>
                <span class="category-count">3 Tools</span>
            </div>
            <div class="calc-grid">
                <a href="baking-conversion-calculator.php" class="calc-card slide-in-right" data-name="Baking Conversion">
                    <div class="calc-icon">🧁</div>
                    <div class="calc-title">Baking Conversion</div>
                    <div class="calc-desc">Convert baking measurements with precision for perfect results.</div>
                </a>
                <a href="pizza-dough-calculator.php" class="calc-card slide-in-right" data-name="Pizza Dough Calculator">
                    <div class="calc-icon">🍕</div>
                    <div class="calc-title">Pizza Dough Calculator</div>
                    <div class="calc-desc">Calculate pizza dough ingredients for perfect homemade pizza.</div>
                    <span class="calc-badge">Popular</span>
                </a>
                <a href="bread-baker-calculator.php" class="calc-card slide-in-right" data-name="Bread Baker Calculator">
                    <div class="calc-icon">🥖</div>
                    <div class="calc-title">Bread Baker Calculator</div>
                    <div class="calc-desc">Calculate bread ingredients with baker's percentage formulas.</div>
                </a>
            </div>
        </div>
        ...
        <div class="category fade-in" data-category="nutrition">
            <div class="category-header">
                <span class="category-icon">🥗</span>
                <h2 class="category-title">Nutrition & Planning</h2>
                <span class="category-count">2 Tools</span>
            </div>
            <div class="calc-grid">
                <a href="nutrition-calculator.php" class="calc-card slide-in-left" data-name="Nutrition Calculator">
                    <div class="calc-icon">🥗</div>
                    <div class="calc-title">Nutrition Calculator</div>
                    <div class="calc-desc">Calculate nutritional values for recipes and meal planning.</div>
                </a>
                <a href="meal-prep-calculator.php" class="calc-card slide-in-left" data-name="Meal Prep Calculator">
                    <div class="calc-icon">📦</div>
                    <div class="calc-title">Meal Prep Calculator</div>
                    <div class="calc-desc">Plan meals, portions, and ingredients for weekly meal prep.</div>
                </a>
            </div>
        </div>
    ...
    <footer class="fade-in">
        <p>👨‍🍳 Cooking Calculators | 9 Free Tools</p>
        <p style="margin-top: 8px; font-size: 0.875rem;">Professional cooking and recipe calculations</p>
    </footer>
